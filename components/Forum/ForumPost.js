...
export default function ForumPost() {
  return (
    <div className="flex items-center justify-center p-3 bg-gray-100">
      <div className="w-full px-4 py-3 bg-white border rounded-lg shadow-sm">
        ...
        <p className="mt-2 text-lg leading-normal text-gray-800 md:leading-relaxed">
        ...
        <div className="flex items-center mt-3 text-lg text-gray-500">
          <img
            className="mr-0.5"
          ...
          />
          <span className="ml-1 hover:underline cursor-pointer">47 • 26 comments</span>
        </div>
      </div>
    </div>
  );
