        ...
        <div className="grid gap-6 row-gap-10 lg:grid-cols-2">
          <div className="lg:py-6 lg:pr-16">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-xl font-bold">Step 4</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              <div className="flex flex-col items-center mr-4">
                <div>
                  <div className="flex items-center justify-center w-10 h-10 border border-green-600 rounded-full">
                    <svg
                      className="w-6 text-green-700"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                      <polyline
              ...
              <div className="pt-1">
                <p className="mb-2 text-lg font-bold text-green-600">Success</p>
