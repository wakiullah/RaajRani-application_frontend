  ...
  return (
    <section className="bg-gray-50 text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <p className="text-center text-lg mt-6">{`What Clint's Say About US`}</p>
        <div className="flex flex-wrap -m-4 mt-16 ">
          <Swiper
            ...
            className="mySwiper flex flex-wrap -m-4"
            autoplay={true}
          >
            <SwiperSlide className="p-4 md:w-1/2 w-full">
              <div className="">
                  ...
                  <div className="text-left">
                    <a className="inline-flex items-center">
                      <Image
                        ...
                        alt="testimonial"
                        src="/rajarani.jpeg"
                        className="w-12 bg-black h-12 rounded-full flex-shrink-0 object-cover object-center"
                      />
...
//     <section className="bg-gray-50 text-gray-600 body-font">
//   <div className="container px-5 py-24 mx-auto">
//     <h1 className="text-center mb-10 text-gray-600 font-bold text-3xl">Testimonials</h1>
...
//               <span className="text-gray-500 text-lg">UI DEVELOPER</span>
//             </span>
//           </a>
//         </div>
//       </div>
...
//               <span className="text-gray-500 text-lg">DESIGNER</span>
//             </span>
//           </a>
//         </div>
//       </div>
