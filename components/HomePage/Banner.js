...
import ButtonGreen from "../Sort/ButtonGreen";
import Button from "../Sort/ButtonGreen";
      ...
      <div className="container mx-auto flex px-5 pt-12 md:flex-row flex-col items-center">
        <div className="lg:flex-grow w-full lg:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex lg:flex-row">
            <button className="bg-gray-200 inline-flex py-3 md:mt-4 px-5 rounded-lg items-center hover:bg-gray-300 focus:outline-none">
              <svg
            ...
            <button className="bg-gray-200 inline-flex py-3 px-5 xl:mt-4 rounded-lg items-center lg:ml-4  ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-300 focus:outline-none">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-6 h-6"
